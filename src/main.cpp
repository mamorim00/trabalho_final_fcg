...
class Enemy{
    public:
        ...
        enemyMove(float delta_t, glm::vec4 playerPos){
...
public:
    ...
    glm::vec4 position;
    glm::vec4 direction;
    Player(glm::vec4 position, glm::vec4 direction){
        this->position = position;
        this->hp = 5;
        this->speed = 0.5f;
    }
    ...
    void playerMove(glm::vec4 newPosition){
        this->position += newPosition;
    }
    void playerSetPosition(glm::vec4 newPosition){
        this->position = newPosition;
    }
    void playerMoveDirection(glm::vec4 newDirection){
...
int main(int argc, char* argv[])
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //#########
        //usando um vetor para zerar a posição y, mantendo o jogador sempre no y = 0
