...
int main()
{
    ...
    GLFWwindow* window;
    window = glfwCreateWindow(800, 800, "INF01047 - 00313306 - Thiago Parisotto Dias", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
...
//    glfwSetScrollCallback(window, ScrollCallback);
    ...
    glm::vec4 camera_position_c  = glm::vec4(3.0f,0.0f,3.0f,1.0f); // Ponto "c", centro da câmera
